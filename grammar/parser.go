			...
			xxVAL.expr = &data.Expression{
				Expression: &data.Expression_BinaryExpression{
					BinaryExpression: &data.BinaryExpression{
						...
						Left:     &data.Expression{Expression: &data.Expression_Text{xxDollar[1].s}},
						Right:    xxDollar[3].expr,
					},
				},
			}
