...
//line grammar/grammar.y:537
		{
			xxVAL.expr = &data.Expression{
				Expression: &data.Expression_StringIdentifier{StringIdentifier: xxDollar[1].s},
			}
		}
	case 59:
		xxDollar = xxS[xxpt-3 : xxpt+1]
